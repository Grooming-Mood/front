          ...
          <Nav.List>
              ...
              <Nav.Item className={"nav-item"}>
                  <Nav.Link
                      ...
                      <img src={HappyIcon} alt="Happy" style={{"width":"60%"}}/>
                  </Nav.Link>
              </Nav.Item>
              <Nav.Item className={"nav-item"}>
                  <Nav.Link
                      ...
                      <img src={SadIcon} alt="Sad" style={{"width":"70%"}}/>
                  </Nav.Link>
              </Nav.Item>
              <Nav.Item className={"nav-item"}>
                  <Nav.Link
                      ...
                      <img src={AngryIcon} alt="Angry" style={{"width":"70%"}}/>
                  </Nav.Link>
              </Nav.Item>
              <Nav.Item className={"nav-item"}>
                  <Nav.Link
                      ...
                      <img src={NormalIcon} alt="Normal" style={{"width":"70%"}}/>
                  </Nav.Link>
              </Nav.Item>
              <Nav.Item className={"nav-item"}>
                  <Nav.Link
                      to="/setting"
                      setting={"nav-setting"}>
                      <img src={SettingIcon} alt="Setting" style={{"width":"80%"}}/>
                  </Nav.Link>
              </Nav.Item>
              <Nav.Item className={"nav-item"}>
                  <Nav.Link
                      ...
                      <img src={ChatbotIcon} alt="Chatbot" style={{"width":"80%"}}/>
                  </Nav.Link>
              </Nav.Item>
          </Nav.List>
      </Nav>
